...
| 347 | 8.2.3.4, sidebar | "time/h is a memory-mapped register, not a CSR." | Replace with "mtime is a 64-bit memory-mapped register, not a CSR. The other performance-monitoring registers listed here are CSRs (see Table I.9)." | Sotaro Fujimoto, Japan | 9/9/26 |
